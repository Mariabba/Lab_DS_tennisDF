...
df['country_name'] = df['country_name'].replace(['Unknown','Urugay','New Zeland','United States of America','Great Britain', 'North Macedonia'],['nan', 'Uruguay', 'New Zealand','United States','United Kingdom','Macedonia'])


print(df['country_name'].unique())

df.to_csv("data/work/countries_corrected.csv")